...
export class ProductsService implements OnInit {
  ...
  async addOneItemToCart(id: string) {
    ...
    if (!query.empty) {
      ...
      this.toastr.success(
        `One more ${this.singleProductFromQuery.productName} added to cart.`,
      )
  ...
  async removeOneItemFromCart(id: string) {
    ...
    if (!query.empty) {
      ...
      this.singleProductFromQuery = data
      this.toastr.warning(
        `One ${this.singleProductFromQuery.productName} removed from cart.`,
      )
      let index = this.cart.findIndex(
        (item) => item.productId == this.singleProductFromQuery.productId,
      )
